...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  if (env.LINE_CHANNEL_ACCESS_TOKEN) envVars.LINE_CHANNEL_ACCESS_TOKEN = env.LINE_CHANNEL_ACCESS_TOKEN;
  if (env.LINE_CHANNEL_SECRET) envVars.LINE_CHANNEL_SECRET = env.LINE_CHANNEL_SECRET;
  if (env.LINE_DM_POLICY) envVars.LINE_DM_POLICY = env.LINE_DM_POLICY;
